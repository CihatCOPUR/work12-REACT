// const n = +prompt(`n değerini giriniz:`);
// const m = +prompt(`m değerini giriniz:`);
// const k = +prompt(`k değerini giriniz:`);
// if (n<m&&n<k) {
//     sonuc=(`${n} en küçük sayıdır`);

// } else if (m<n&&m<k){
//     sonuc=(`${m} en küçük sayıdır`);
// }
// else {
//     sonuc=(`${k} en küçük sayıdır`);
// }
// console.log(sonuc);



// const vize=+prompt(`vize puanınızı giriniz`);
// const final=+prompt(`final puanınızı giriniz`);

// const gecti=(vize,final)=>(vize+final)/2>=50 ? `geçtiniz`:`kaldınız`;
// console.log(gecti(vize,final));

// const maaş=+prompt(`Maaşınızı giriniz:`);

// const zam=(maaş)=>maaş<5500 ? `yeni maaş =${maaş*1.5}` : `yeni maaş =${maaş*1.1}`;
// console.log(zam(maaş));

// const gelir = +prompt(`gelirinizi giriniz:`);
// const gider = +prompt(`giderinizi giriniz:`);
// let fark = gelir-gider;

// const kredi=(fark)=>fark>=5500 ? `kredi verilebilir` :`kredi verilemez` ;
// console.log(kredi(fark));
...
//   } 
//   else if (puan>100) {alert(`yanlış değer girdiniz`);
...
let ay = +prompt(`ayın sırasını giriniz`);
